  ...
  private _products = signal<Product[]>([
    {
      ...
      precio: 120000,
      imagen: ['assets/images/adidas/1jpg', 'assets/images/adidas/3.jpg'],
      marca: 'Nike',
      tipo: 'micro',
      tallas: ['39', '40', '41', '42'],
      stock: 10,
    },
    {
      ...
      precio: 110000,
      imagen: ['assets/images/2.jpg', 'assets/images/1.jpg'],
      marca: 'Adidas',
      tipo: 'sintetica',
      tallas: ['40', '41', '42', '43'],
      stock: 8,
    },
    {
      ...
      precio: 100000,
      imagen: ['assets/images/3.jpg', 'assets/images/2.jpg'],
      marca: 'Puma',
      tipo: 'micro',
      tallas: ['38', '39', '40', '41'],
      stock: 5,
